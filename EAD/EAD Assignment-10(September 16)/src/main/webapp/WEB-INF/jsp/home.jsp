    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item active">
           Welcome <a href="/uploading"><img src=${loginfm.url} height="100px" width="100px"/></a>

          </li>


          <li class="nav-item active">
            <a class="nav-link" href="/loginsuccess">Home Page
            </a>
          </li>
          <li class="nav-item">
                    ...
                    <div class="col-md-9 register-right">
                         <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Employee Welcome Page</h3>
                            ...
                            ${loginfm.contact}
                             ...
                             <td>
                            ${loginfm.organisation}
                             </td>
                             </tr>
                  
                           </table>
                  <a href="editForm?id=${loginform.email}">Edit </a>           
                                    </div>
                                </div>
                            </div>
                       </div>
